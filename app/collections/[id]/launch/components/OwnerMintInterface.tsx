        ...
        <div className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 cosmic-card border border-[#00d4ff]/30 rounded-lg text-white placeholder:text-white/50 font-mono text-sm"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              defaultValue="1"
              className="w-full px-4 py-3 cosmic-card border border-[#00d4ff]/30 rounded-lg text-white"
            />
          ...
          <button
            className="w-full px-6 py-3 bg-[#00d4ff] hover:bg-[#00b8e6] text-white font-semibold rounded-lg transition-colors"
            disabled
          >
