                ...
                {colorMoodSuggestions.map((mood, index) => (
                  ...
                  >
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-white text-xs group-hover:text-[#e27d0f]">{mood}</span>
                    </div>
                  </button>
                ))}
              </div>
              ...
              <div className="p-6">
                <div className="space-y-4">
                  ...
                  <button
                    ...
                    className="w-full px-6 py-3 bg-purple-600 hover:bg-purple-700 disabled:bg-purple-400 text-white rounded-lg font-semibold transition-colors disabled:cursor-not-allowed flex items-center justify-center gap-2"
                  >
