    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      ...
      <div className="ml-64 p-8 pt-32">
        <div className="max-w-7xl mx-auto">
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-white mb-2">Generation Errors</h1>
            <p className="text-gray-400">View and debug image generation API errors</p>
          </div>
            ...
            <div className="bg-slate-800/50 rounded-lg p-6 mb-6 border border-slate-700">
              ...
              <div className="grid grid-cols-3 md:grid-cols-6 gap-4">
                ...
                <div className="bg-red-900/30 rounded p-3 border border-red-800/50">
                  <div className="text-sm text-red-400">API Errors</div>
                ...
                <div className="bg-yellow-900/30 rounded p-3 border border-yellow-800/50">
                  <div className="text-sm text-yellow-400">Upload/Download</div>
          ...
          <div className="bg-slate-800/50 rounded-lg p-6 mb-6 border border-slate-700">
            <div className="flex items-center gap-4 mb-4">
              ...
              <select
                ...
                className="px-4 py-2 bg-slate-900 border border-slate-600 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-purple-500"
              >
          ...
          {loading ? (
            ...
            <div className="bg-slate-800/50 rounded-lg p-8 text-center border border-slate-700">
              <div className="text-gray-400 text-lg">No generation errors found</div>
            </div>
          ) : (
                ...
                >
                  ...
                  {expandedErrors.has(err.id) && (
                    <div className="border-t border-slate-700 p-4 bg-slate-900/50">
                      <div className="space-y-4">
                        <div>
                          <div className="text-sm font-medium text-gray-400 mb-1">Error Message:</div>
                        ...
                        {err.prompt && (
                          <div>
                            <div className="text-sm font-medium text-gray-400 mb-1">Prompt:</div>
                            <div className="text-white font-mono text-sm bg-slate-800 p-3 rounded break-all">
                              {err.prompt}
                            </div>
                          </div>
                        ...
                        {err.error_details && (
                          <div>
                            <div className="text-sm font-medium text-gray-400 mb-1">Error Details:</div>
                            <pre className="text-white font-mono text-xs bg-slate-800 p-3 rounded overflow-auto max-h-64">
                        ...
                        {err.api_response && (
                          <div>
                            <div className="text-sm font-medium text-gray-400 mb-1">API Response:</div>
                            <pre className="text-white font-mono text-xs bg-slate-800 p-3 rounded overflow-auto max-h-64">
