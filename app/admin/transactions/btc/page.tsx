    ...
    return (
      ...
      <div className="container mx-auto px-6 py-12">
        <div className="max-w-7xl mx-auto">
            ...
            <h1 className="text-3xl font-bold text-white mb-4">Bitcoin Transactions</h1>
      ...
      <div className="ml-64">
        ...
        <div className="mb-8">
            ...
            <div>
                ...
                <p className="text-gray-400 text-lg">Track all Bitcoin payment transactions</p>
                <div className="mt-4 flex flex-wrap gap-2">
                  <Link href="/admin/transactions/btc" className="px-4 py-2 bg-orange-600/80 hover:bg-orange-600 text-white rounded-xl font-semibold text-sm transition-all duration-200 border border-orange-500/50">
                  ₿ Bitcoin
                </Link>
                  <Link href="/admin/transactions/sol" className="px-4 py-2 bg-slate-800/50 hover:bg-slate-800 text-white rounded-xl font-semibold text-sm transition-all duration-200 border border-gray-700">
                  ◎ Solana
                </Link>
                </div>
            </div>
        ...
        {loading ? (
          <div className="text-center py-12">
            ...
            <p className="text-gray-400 mt-4">Loading Bitcoin transactions...</p>
          </div>
        ) : (
            <div className="bg-slate-900/50 border border-gray-800 rounded-2xl p-6 shadow-2xl backdrop-blur-sm">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-2xl font-bold text-white">Bitcoin Payment Transactions</h2>
